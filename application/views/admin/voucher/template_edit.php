...
<section class="content">
  ...
  <h3 class="box-title">Edit Template Voucher</h3>
      ...
      <div class="modal-body">
          ...
          <div class="col-sm-4 col-pad">
            <div class="form-group image--preview">
              ...
              <div class="gbrupload" style="background-image: url('<?php echo base_url('assets/image/voucher/'.$row['template']) ?>');">
          ...
          <div class="col-sm-4 col-pad">
            <div class="form-group">
              ...
              <input type="text" class="priceformat form-control" name="disc" required value="<?php echo $row['voucher_value'] ?>">
            </div>
            ...
            <label>Publish</label>
                  <div class="radio">
                    <label>
                      <input type="radio" name="publish" value="1" <?php echo ($row['publish'] == 1) ? 'checked' : ''; ?>>
                      Yes
                    </label>
                    &nbsp;&nbsp;&nbsp;
                    <label>
                      <input type="radio" name="publish" value="0" <?php echo ($row['publish'] == 0) ? 'checked' : ''; ?>>
                      No
                    </label>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label><a href="<?php echo base_url('admin/voucher/delete_template/'.$row['ID']) ?>" onclick="confirm('Are you sure?')">Delete</a></label>
                </div>
          </div>
