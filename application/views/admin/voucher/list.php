      ...
      <div class="modal-body">
          ...
          <div class="max-disc form-group hidden">
           <label>Maksimal</label>
                <div class="input-group">
                  <input type="text" name="potongan_max" min="1" class="form-control priceformat" placeholder="Rp">
                </div>                
          </div>
          </div>
          <div class="col-sm-6 col-pad">
...
<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">QR Code Generator</h4>
      </div>
...
<section class="content">
  ...
  <h3 class="box-title">Voucher List</h3>
    ...
    <a href="#" class="btn btn-success btn-sm" data-toggle="modal" data-target="#myModal2">Create Qrcode</a>         
    </div>
  ...
  <div class="box-body">
   ...
   <table id="table01" class="table table-striped table-bordered">
                ...
                <tbody>
                  <?php
                  $sql = $conn->querry("SELECT*FROM voucher");
                  while ($real = $sql->fetch_array()){
                    ?>
                  <tr>
                    <th class="no-sort" width="10">
                    <input type="checkbox" id="selectAll" />
                    ...
                    <td><?=$resl['vou_for']?></td>
                    <td><?=$resl['max']?></td>
                    <td><?=$resl['min_amount']?></td>
                    <td><?=$resl['usage_vou']?></td>
                    <td><?=$resl['input_vou']?></td>
                    <td><?=$resl['start_voucher']?></td>
                    <td><?=$resl['end_voucher']?></td>
                    <td><?=$resl['exp_vou']?></td>
                    <td><img src="gbrqrcode/?>$resl['gbrqrcode']?>" alt=""></td>
                   </tr>
                <?php 
                $no = 1;
                ...
                <tr>
                  ...
                  <td style="text-align: center"><?php echo $key->qrcode ?></td>
                 </tr>
                 <?php
                 }
                 ?>
