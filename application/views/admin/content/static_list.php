...
<div class="box">
  ...
  <div class="box-tools">
   <a href="<?php echo base_url('entersite/static-page/new') ?>" class="btn btn-success pull-right">
  ...
  <form action="<?php echo base_url('process_entersite/static_action'); ?>" method="post" enctype="multipart/form-data">
  ...
  <table id="table-01" class="table table-bordered">
    ...
    ?>
    <tr>
      <td><input class="checktbl" type="checkbox" name="pages[]" value="<?php echo $key->id_page; ?>"></td>
      <td><a href="<?php echo base_url('entersite/static-page/edit/').$key->id_page ?>"><?php echo $key->section ?></a></td>
      <td><a href="<?php echo base_url('page/'.$key->link) ?>" target="_blank"><?php echo $key->title_kategori ?></a></td>
      <td><input type="text" value="<?php echo base_url('page/'.$key->link) ?>" class="form-control" style="min-width: 300px; height: 30px;" onclick="this.select();"></td>
