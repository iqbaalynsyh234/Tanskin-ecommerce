...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form id="myForm" action="<?php echo base_url().'process_entersite/slideshow' ?>" method="post" enctype="multipart/form-data">
...
<div class="box">
  ...
  <h3 class="box-title">Slideshows</h3>
  <div class="box-tools">
   <button class="btn btn-success pull-right" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i> Tambah Slideshows</button>     
  </div>
  ...
  <form action="<?php echo base_url('process_entersite/slide_action'); ?>" method="post">
    ...
    <input type="hidden" name="urlback" value="content/sliders">
  ...
  <table id="table-01" class="table table-bordered">
    ...
    <td><a href="#" data-name="<?php echo $key->name; ?>" data-image="<?php echo $key->image; ?>" data-id="<?php echo $key->id; ?>" data-publish="<?php echo $publish; ?>" data-url="<?php echo $key->url; ?>" class="update_banner_modal"><?php echo $key->name ?></a></td>
...
$('#myModal').on('hide.bs.modal', function (e) {
  ...
  $('#myForm').attr('action', '<?php echo base_url().'process_entersite/slideshow' ?>');
...
$(".update_banner_modal").on('click', function(){
  $('#myModal').modal('show');
    $('#myModal h4#myModalLabel').text('Ubah Slide');
        var id  = $(this).data('id'),
        name    = $(this).data('name'),
        image   = $(this).data('image'),
        url     = $(this).data('url'),
        publish = $(this).data('publish');
    $('#myForm').attr('action', '<?php echo base_url().'process_entersite/slideshow_edit/' ?>'+id);
