<section class="content-header">
      <h1>
        Import Order
        <small>Import file orders Tokopedia.</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Import</a></li>
        <li class="active">Tokopedia</li>
      </ol>
</section>
...
<section class="content">
    <div class="box">
            <div class="box-header with-border">
              ...
              <div class="box-tools">
              <a href="<?php echo base_url('excel/template/tokopedia_template.xlsx') ?>" class="btn btn-success" download><i class="fa fa-plus"></i> Download Template</a>          
              </div>
            </div>
            ...
            <form role="form" action="" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="hidden" name="template" value="tokopedia">
                  ...
                  <tbody>
                      ...
                      <tr>
                        ...
                        <td class="<?php echo ($value['error'] == 'error') ? 'error-data' : ''; ?>">
                            ...
                            <input type="hidden" name="barcode[]" value="<?php echo trim($value['barcode']) ?>">
                        </td>
                        <td>
