  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title text-center" id="myModalLabel">Tambah Marketplace</h4>
      </div>
...
<div class="tab-content">
   <h3 class="box-title">Marketplace
    <button id="add-modal" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Tambah Marketplace</button>
   </h3>
   <table class="table table-bordered table-middle">
     <thead>
       <tr>
         <th colspan="2">Daftar Marketplace</th>
         <th width="200px"></th>
       </tr>
     </thead>
     <tbody>
     ...
     ?>
       <tr>
         <td width="60px" style="text-align: center" data-id="<?php echo $key->id_sm ?>" data-sosial="<?php echo $key->socialmedia ?>">
           <span class="market-icon <?php echo $key->socialmedia ?>"></span>
         </td>
...
$('#add-modal').on('click', function(){
    $('#myModal').modal('show');
    $('#myModal h4#myModalLabel').text('Tambah Marketplace');
...
$('.update-modal').on('click', function(){
    $('#myModal').modal('show');
    $('#myModal h4#myModalLabel').text('Ubah Marketplace');
